...
public interface UserToken
{
	...
	public void setSignature( byte[] signature );	//set signature can only happen once since it is final
	
	public byte[] getSignature();	//get the signature

	public String toString();	//very simple toString method for signatures
	
	public void setPublicKey( byte[] publicKey );	//sets public key for the file server
	
	public PublicKey getPublicKey();	//get the public key
