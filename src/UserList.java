...
import java.util.*;
	...
	public class UserList implements java.io.Serializable {
		...
		public synchronized void addUser(String username, byte[] hashedPassword)
		{
		...
		public synchronized byte[] getHashedPassword(String user)
		{
			return list.get(user).getHashedPassword();
		}

		// additional method to return the list of users
	...
	class User implements java.io.Serializable {
		...
		public void setHashedPassword(byte[] hash)
		{
			hashedPassword = hash;
		}
