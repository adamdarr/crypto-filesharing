...
public interface GroupClientInterface
{
     ...
     *
     */
    public UserToken getToken(final String username, final byte[] hashedPassword);
     ...
     *
     */
    public boolean createUser(final String username, final byte[] hashedPassword, final UserToken token);
